...
def load_data():
    ...
    with open('results/paper_experiments/exp1_defense_comparison.pkl', 'rb') as f:
        exp1 = pickle.load(f)
    with open('results/paper_experiments/exp2_ablation_study.pkl', 'rb') as f:
        exp2 = pickle.load(f)
    return exp1, exp2
...
def main():
    ...
    output_dir = Path('results/paper_experiments/figures')
