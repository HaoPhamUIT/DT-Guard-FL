#!/usr/bin/env python3
"""
EXPERIMENT 3: COMPREHENSIVE DEFENSE COMPARISON - ToN-IoT Dataset
================================================================
...
This mirrors experiments/thesis/run_experiment3.py but uses ToN-IoT dataset.
"""
...
# =============================================================================
# Configuration (matching CICIoT2023 experiments for fair comparison)
# =============================================================================
NUM_CLIENTS       = 20
NUM_MALICIOUS     = 5       # 25% malicious (5/20)
NUM_ROUNDS        = 10
LOCAL_EPOCHS      = 3
BATCH_SIZE        = 32
LEARNING_RATE     = 0.001
...
def main():
    start = datetime.now()
    print("=" * 90)
    print("EXPERIMENT 3: COMPREHENSIVE DEFENSE COMPARISON - ToN-IoT Dataset")
    print("=" * 90)
    print(f"Start: {start.strftime('%Y-%m-%d %H:%M:%S')}")
    print(f"Setup: {NUM_CLIENTS} clients, {NUM_MALICIOUS} malicious (25%), "
    ...
    # Get project root (3 levels up from experiments/ton_iot)
    ...
    # Save raw results
    with open(results_dir / 'exp3_comprehensive_toniot.pkl', 'wb') as f:
    ...
    print("\n" + "=" * 90)
    print("TABLE 4: ACCURACY UNDER POISONING ATTACKS - ToN-IoT (higher = better)")
    print("=" * 90)
    ...
    print("\n" + "=" * 90)
    print("TABLE 5: ERROR RATE (%) - ToN-IoT (lower = better)")
    print("=" * 90)
    header = f"{'Defense':<15}"
    ...
    with open(results_dir / 'exp3_summary_toniot.json', 'w') as f:
        json.dump(summary, f, indent=2)

    end = datetime.now()
    print(f"\n{'='*90}")
    print(f"✅ Experiment 3 (ToN-IoT) completed!")
    print(f"   Duration: {end - start}")
    print(f"   Results:  {results_dir / 'exp3_comprehensive_toniot.pkl'}")
    print(f"   Summary:  {results_dir / 'exp3_summary_toniot.json'}")
