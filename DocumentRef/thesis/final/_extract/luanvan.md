![](_extract/media/media/image1.emf)
...
[LỜI CẢM ƠN [1](#lời-cảm-ơn)](#lời-cảm-ơn)

[LỜI CAM ĐOAN [2](#lời-cam-đoan)](#lời-cam-đoan)

[MỤC LỤC [3](#mục-lục)](#mục-lục)

[DANH MỤC TỪ VIẾT TẮT [8](#danh-mục-từ-viết-tắt)](#danh-mục-từ-viết-tắt)

[DANH MỤC BẢNG [12](#danh-mục-bảng)](#danh-mục-bảng)

[DANH MỤC HÌNH [13](#danh-mục-hình)](#danh-mục-hình)

[TÓM TẮT LUẬN VĂN [14](#tóm-tắt-luận-văn)](#tóm-tắt-luận-văn)

[Chương 1. MỞ ĐẦU [1](#chương-1.-mở-đầu)](#chương-1.-mở-đầu)

[1.1. Động lực nghiên cứu [1](#động-lực-nghiên-cứu)](#động-lực-nghiên-cứu)

[1.2. Phát biểu bài toán [1](#phát-biểu-bài-toán)](#phát-biểu-bài-toán)

[1.3. Các thách thức [2](#các-thách-thức)](#các-thách-thức)

[1.4. Mục tiêu và phạm vi nghiên cứu [2](#mục-tiêu-và-phạm-vi-nghiên-cứu)](#mục-tiêu-và-phạm-vi-nghiên-cứu)

[1.5. Đóng góp của luận văn [3](#đóng-góp-của-luận-văn)](#đóng-góp-của-luận-văn)

[1.6. Bố cục của luận văn [4](#bố-cục-của-luận-văn)](#bố-cục-của-luận-văn)

[Chương 2. TỔNG QUAN VỀ VẤN ĐỀ NGHIÊN CỨU [5](#chương-2.-tổng-quan-về-vấn-đề-nghiên-cứu)](#chương-2.-tổng-quan-về-vấn-đề-nghiên-cứu)

[2.1. Giới thiệu về Internet of Things (IoT) [5](#giới-thiệu-về-internet-of-things-iot)](#giới-thiệu-về-internet-of-things-iot)

[2.1.1. Khái niệm và kiến trúc IoT [5](#khái-niệm-và-kiến-trúc-iot)](#khái-niệm-và-kiến-trúc-iot)

[2.1.2. Thách thức an toàn thông tin trong IoT [6](#thách-thức-an-toàn-thông-tin-trong-iot)](#thách-thức-an-toàn-thông-tin-trong-iot)

[2.2. Hệ thống phát hiện xâm nhập mạng (Intrusion Detection System) [7](#hệ-thống-phát-hiện-xâm-nhập-mạng-intrusion-detection-system)](#hệ-thống-phát-hiện-xâm-nhập-mạng-intrusion-detection-system)

[2.2.1. Khái niệm và nguyên lý hoạt động của IDS [7](#khái-niệm-và-nguyên-lý-hoạt-động-của-ids)](#khái-niệm-và-nguyên-lý-hoạt-động-của-ids)

[2.2.2. Phân loại IDS [8](#phân-loại-ids)](#phân-loại-ids)

[2.2.3. Hạn chế của IDS truyền thống trong ngữ cảnh IoT [9](#hạn-chế-của-ids-truyền-thống-trong-ngữ-cảnh-iot)](#hạn-chế-của-ids-truyền-thống-trong-ngữ-cảnh-iot)

[2.3. Tổng quan về Học liên kết (Federated Learning) [10](#tổng-quan-về-học-liên-kết-federated-learning)](#tổng-quan-về-học-liên-kết-federated-learning)

[2.3.1. Khái niệm và nguyên lý FL [10](#khái-niệm-và-nguyên-lý-fl)](#khái-niệm-và-nguyên-lý-fl)

[2.3.2. FL trong ngữ cảnh IoT IDS [10](#fl-trong-ngữ-cảnh-iot-ids)](#fl-trong-ngữ-cảnh-iot-ids)

[2.3.3. Các bộ dữ liệu chuẩn cho IoT IDS [12](#các-bộ-dữ-liệu-chuẩn-cho-iot-ids)](#các-bộ-dữ-liệu-chuẩn-cho-iot-ids)

[2.4. Các hình thức tấn công trong Federated Learning [13](#các-hình-thức-tấn-công-trong-federated-learning)](#các-hình-thức-tấn-công-trong-federated-learning)

[2.4.1. Phân loại tấn công trong FL [13](#phân-loại-tấn-công-trong-fl)](#phân-loại-tấn-công-trong-fl)

[2.4.2. Các dạng tấn công poisoning và backdoor [14](#các-dạng-tấn-công-poisoning-và-backdoor)](#các-dạng-tấn-công-poisoning-và-backdoor)

[2.5. Các phương pháp phòng thủ hiện có cho Federated Learning [16](#các-phương-pháp-phòng-thủ-hiện-có-cho-federated-learning)](#các-phương-pháp-phòng-thủ-hiện-có-cho-federated-learning)

[2.5.1. Nhóm thống kê cổ điển [16](#nhóm-thống-kê-cổ-điển)](#nhóm-thống-kê-cổ-điển)

[2.5.2. Nhóm phân tích nâng cao [17](#nhóm-phân-tích-nâng-cao)](#nhóm-phân-tích-nâng-cao)

[2.5.3. Phương pháp dựa trên Shapley Value [18](#phương-pháp-dựa-trên-shapley-value)](#phương-pháp-dựa-trên-shapley-value)

[2.6. Digital Twin và ứng dụng trong FL-IoT [19](#digital-twin-và-ứng-dụng-trong-fl-iot)](#digital-twin-và-ứng-dụng-trong-fl-iot)

[2.6.1. Khái niệm Digital Twin [19](#khái-niệm-digital-twin)](#khái-niệm-digital-twin)

[2.6.2. Các nghiên cứu DT-FL gần đây [19](#các-nghiên-cứu-dt-fl-gần-đây)](#các-nghiên-cứu-dt-fl-gần-đây)

[2.6.3. Tổng hợp và nhận diện khoảng trống [20](#tổng-hợp-và-nhận-diện-khoảng-trống)](#tổng-hợp-và-nhận-diện-khoảng-trống)

[2.7. Phương pháp nghiên cứu [22](#phương-pháp-nghiên-cứu)](#phương-pháp-nghiên-cứu)

[2.8. Tổng kết chương [22](#tổng-kết-chương)](#tổng-kết-chương)

[Chương 3. CƠ SỞ LÝ THUYẾT VÀ CÔNG NGHỆ NỀN TẢNG [23](#chương-3.-cơ-sở-lý-thuyết-và-công-nghệ-nền-tảng)](#chương-3.-cơ-sở-lý-thuyết-và-công-nghệ-nền-tảng)

[3.1. Cơ sở lý thuyết Federated Learning [23](#cơ-sở-lý-thuyết-federated-learning)](#cơ-sở-lý-thuyết-federated-learning)

[3.1.1. Bài toán tối ưu phân tán trong FL [23](#bài-toán-tối-ưu-phân-tán-trong-fl)](#bài-toán-tối-ưu-phân-tán-trong-fl)

[3.1.2. Thuật toán FedAvg [23](#thuật-toán-fedavg)](#thuật-toán-fedavg)

[3.1.3. Dữ liệu Non-IID trong FL [24](#dữ-liệu-non-iid-trong-fl)](#dữ-liệu-non-iid-trong-fl)

[3.1.4. Weighted Cross-Entropy Loss cho mất cân bằng lớp [25](#weighted-cross-entropy-loss-cho-mất-cân-bằng-lớp)](#weighted-cross-entropy-loss-cho-mất-cân-bằng-lớp)

[3.2. Cơ sở lý thuyết các tấn công poisoning và backdoor [25](#cơ-sở-lý-thuyết-các-tấn-công-poisoning-và-backdoor)](#cơ-sở-lý-thuyết-các-tấn-công-poisoning-và-backdoor)

[3.2.1. Tấn công LIE (A Little Is Enough) [25](#tấn-công-lie-a-little-is-enough)](#tấn-công-lie-a-little-is-enough)

[3.2.2. Tấn công Min-Max và Min-Sum [26](#tấn-công-min-max-và-min-sum)](#tấn-công-min-max-và-min-sum)

[3.2.3. Tấn công MPAF [26](#tấn-công-mpaf)](#tấn-công-mpaf)

[3.2.4. Tấn công Backdoor [26](#tấn-công-backdoor)](#tấn-công-backdoor)

[3.2.5. Free-rider problem [27](#free-rider-problem)](#free-rider-problem)

[3.3. Cơ sở lý thuyết Digital Twin [27](#cơ-sở-lý-thuyết-digital-twin)](#cơ-sở-lý-thuyết-digital-twin)

[3.3.1. Mô hình khái niệm Digital Twin [27](#mô-hình-khái-niệm-digital-twin)](#mô-hình-khái-niệm-digital-twin)

[3.3.2. Server-side DT cho behavioral testing [29](#server-side-dt-cho-behavioral-testing)](#server-side-dt-cho-behavioral-testing)

[3.3.3. Kiểm chứng hành vi chủ động vs. Phân tích tham số thụ động [29](#kiểm-chứng-hành-vi-chủ-động-vs.-phân-tích-tham-số-thụ-động)](#kiểm-chứng-hành-vi-chủ-động-vs.-phân-tích-tham-số-thụ-động)

[3.4. Cơ sở lý thuyết mô hình sinh dữ liệu dạng bảng [29](#cơ-sở-lý-thuyết-mô-hình-sinh-dữ-liệu-dạng-bảng)](#cơ-sở-lý-thuyết-mô-hình-sinh-dữ-liệu-dạng-bảng)

[3.4.1. Denoising Diffusion Probabilistic Models (DDPM) [30](#denoising-diffusion-probabilistic-models-ddpm)](#denoising-diffusion-probabilistic-models-ddpm)

[3.4.2. Nhóm Diffusion [30](#nhóm-diffusion)](#nhóm-diffusion)

[3.4.3. Nhóm GAN [31](#nhóm-gan)](#nhóm-gan)

[3.4.4. Tiêu chí đánh giá và lựa chọn [31](#tiêu-chí-đánh-giá-và-lựa-chọn)](#tiêu-chí-đánh-giá-và-lựa-chọn)

[3.5. Cơ sở lý thuyết mô hình Intrusion Detection [32](#cơ-sở-lý-thuyết-mô-hình-intrusion-detection)](#cơ-sở-lý-thuyết-mô-hình-intrusion-detection)

[3.5.1. Mô hình IoTAttackNet [32](#mô-hình-iotattacknet)](#mô-hình-iotattacknet)

[3.5.2. Các chỉ số đánh giá [32](#các-chỉ-số-đánh-giá)](#các-chỉ-số-đánh-giá)

[3.6. Cơ sở lý thuyết bộ dữ liệu thực nghiệm [33](#cơ-sở-lý-thuyết-bộ-dữ-liệu-thực-nghiệm)](#cơ-sở-lý-thuyết-bộ-dữ-liệu-thực-nghiệm)

[3.6.1. CIC-IoT-2023 [33](#cic-iot-2023)](#cic-iot-2023)

[3.6.2. ToN-IoT [34](#ton-iot)](#ton-iot)

[3.7. Tổng kết chương [34](#tổng-kết-chương-1)](#tổng-kết-chương-1)

[Chương 4. ĐỀ XUẤT HỆ THỐNG DT-GUARD [35](#chương-4.-đề-xuất-hệ-thống-dt-guard)](#chương-4.-đề-xuất-hệ-thống-dt-guard)

[4.1. Phát biểu bài toán và ý tưởng cốt lõi [35](#phát-biểu-bài-toán-và-ý-tưởng-cốt-lõi)](#phát-biểu-bài-toán-và-ý-tưởng-cốt-lõi)

[4.1.1. Phát biểu bài toán phòng thủ trong FL-IDS [35](#phát-biểu-bài-toán-phòng-thủ-trong-fl-ids)](#phát-biểu-bài-toán-phòng-thủ-trong-fl-ids)

[4.1.2. Ý tưởng cốt lõi: Kiểm chứng hành vi chủ động [35](#ý-tưởng-cốt-lõi-kiểm-chứng-hành-vi-chủ-động)](#ý-tưởng-cốt-lõi-kiểm-chứng-hành-vi-chủ-động)

[4.1.3. Ký hiệu toán học [36](#ký-hiệu-toán-học)](#ký-hiệu-toán-học)

[4.2. Kiến trúc tổng thể DT-Guard [37](#kiến-trúc-tổng-thể-dt-guard)](#kiến-trúc-tổng-thể-dt-guard)

[4.2.1. Kiến trúc ba thực thể [37](#kiến-trúc-ba-thực-thể)](#kiến-trúc-ba-thực-thể)

[4.2.2. Cấu trúc bên trong DT Verification Environment [40](#cấu-trúc-bên-trong-dt-verification-environment)](#cấu-trúc-bên-trong-dt-verification-environment)

[4.2.3. Lý do thiết kế hai nhánh song song [41](#lý-do-thiết-kế-hai-nhánh-song-song)](#lý-do-thiết-kế-hai-nhánh-song-song)

[4.2.4. Luồng hoạt động 5 bước mỗi vòng FL [42](#luồng-hoạt-động-5-bước-mỗi-vòng-fl)](#luồng-hoạt-động-5-bước-mỗi-vòng-fl)

[4.3. Bộ sinh dữ liệu thách thức (Challenge Data Generator) [42](#bộ-sinh-dữ-liệu-thách-thức-challenge-data-generator)](#bộ-sinh-dữ-liệu-thách-thức-challenge-data-generator)

[4.3.1. Vai trò và yêu cầu [42](#vai-trò-và-yêu-cầu)](#vai-trò-và-yêu-cầu)

[4.3.2. A/B Testing chọn mô hình sinh [43](#ab-testing-chọn-mô-hình-sinh)](#ab-testing-chọn-mô-hình-sinh)

[4.3.3. Quy trình sinh dữ liệu thách thức [44](#quy-trình-sinh-dữ-liệu-thách-thức)](#quy-trình-sinh-dữ-liệu-thách-thức)

[4.4. Pipeline kiểm định hành vi với Trust-Score [45](#pipeline-kiểm-định-hành-vi-với-trust-score)](#pipeline-kiểm-định-hành-vi-với-trust-score)

[4.4.1. Lớp 1: IDS Performance Score [46](#lớp-1-ids-performance-score)](#lớp-1-ids-performance-score)

[4.4.2. Lớp 2: Backdoor Resistance Score [47](#lớp-2-backdoor-resistance-score)](#lớp-2-backdoor-resistance-score)

[4.4.3. Lớp 3: Parameter Deviation Score [47](#lớp-3-parameter-deviation-score)](#lớp-3-parameter-deviation-score)

[4.4.4. Lớp 4: Cross-Round Stability Score [48](#lớp-4-cross-round-stability-score)](#lớp-4-cross-round-stability-score)

[4.4.5. Trust-Score Fusion [49](#trust-score-fusion)](#trust-score-fusion)

[4.5. Cơ chế DT-PW với Effort Gate [50](#cơ-chế-dt-pw-với-effort-gate)](#cơ-chế-dt-pw-với-effort-gate)

[4.5.1. Prediction Divergence [51](#prediction-divergence)](#prediction-divergence)

[4.5.2. Effort Gate [52](#effort-gate)](#effort-gate)

[4.5.3. Performance-Score [52](#performance-score)](#performance-score)

[4.5.4. Trọng số tổng hợp cuối cùng [52](#trọng-số-tổng-hợp-cuối-cùng)](#trọng-số-tổng-hợp-cuối-cùng)

[4.6. Phân tích lý thuyết [53](#phân-tích-lý-thuyết)](#phân-tích-lý-thuyết)

[4.6.1. Tại sao kiểm chứng hành vi vượt trội phân tích tham số thụ động [53](#tại-sao-kiểm-chứng-hành-vi-vượt-trội-phân-tích-tham-số-thụ-động)](#tại-sao-kiểm-chứng-hành-vi-vượt-trội-phân-tích-tham-số-thụ-động)

[4.6.2. Đảm bảo an toàn với sandbox isolation [54](#đảm-bảo-an-toàn-với-sandbox-isolation)](#đảm-bảo-an-toàn-với-sandbox-isolation)

[4.6.3. Độ phức tạp tính toán [54](#độ-phức-tạp-tính-toán)](#độ-phức-tạp-tính-toán)

[4.7. Tổng kết chương [54](#tổng-kết-chương-2)](#tổng-kết-chương-2)

[Chương 5. THỰC NGHIỆM VÀ ĐÁNH GIÁ [55](#chương-5.-thực-nghiệm-và-đánh-giá)](#chương-5.-thực-nghiệm-và-đánh-giá)

[5.1. Thiết lập thực nghiệm [55](#thiết-lập-thực-nghiệm)](#thiết-lập-thực-nghiệm)

[5.1.1. Môi trường thực nghiệm [55](#môi-trường-thực-nghiệm)](#môi-trường-thực-nghiệm)

[5.1.2. Cấu hình Federated Learning [55](#cấu-hình-federated-learning)](#cấu-hình-federated-learning)

[5.1.3. Các phương pháp đối sánh [56](#các-phương-pháp-đối-sánh)](#các-phương-pháp-đối-sánh)

[5.1.4. Các chỉ số đánh giá [56](#các-chỉ-số-đánh-giá-1)](#các-chỉ-số-đánh-giá-1)

[5.1.5. Kịch bản thực nghiệm [57](#kịch-bản-thực-nghiệm)](#kịch-bản-thực-nghiệm)

[5.2. Kịch bản A: Đánh giá hiệu năng phòng thủ [57](#kịch-bản-a-đánh-giá-hiệu-năng-phòng-thủ)](#kịch-bản-a-đánh-giá-hiệu-năng-phòng-thủ)

[5.2.1. Kết quả trên CIC-IoT-2023 [57](#kết-quả-trên-cic-iot-2023)](#kết-quả-trên-cic-iot-2023)

[5.2.2. Kết quả trên ToN-IoT [61](#kết-quả-trên-ton-iot)](#kết-quả-trên-ton-iot)

[5.2.3. So sánh chéo giữa hai dataset [65](#so-sánh-chéo-giữa-hai-dataset)](#so-sánh-chéo-giữa-hai-dataset)

[5.2.4. Giải thích hiện tượng đặc biệt [66](#giải-thích-hiện-tượng-đặc-biệt)](#giải-thích-hiện-tượng-đặc-biệt)

[5.3. Kịch bản B: Đánh giá bộ sinh dữ liệu thách thức [67](#kịch-bản-b-đánh-giá-bộ-sinh-dữ-liệu-thách-thức)](#kịch-bản-b-đánh-giá-bộ-sinh-dữ-liệu-thách-thức)

[5.3.1. Kết quả A/B Testing [67](#kết-quả-ab-testing)](#kết-quả-ab-testing)

[5.3.2. Lý do TabDDPM được chọn [71](#lý-do-tabddpm-được-chọn)](#lý-do-tabddpm-được-chọn)

[5.4. Kịch bản C: Đánh giá tính công bằng và phát hiện free-rider [72](#kịch-bản-c-đánh-giá-tính-công-bằng-và-phát-hiện-free-rider)](#kịch-bản-c-đánh-giá-tính-công-bằng-và-phát-hiện-free-rider)

[5.4.1. Thiết lập kịch bản free-rider [72](#thiết-lập-kịch-bản-free-rider)](#thiết-lập-kịch-bản-free-rider)

[5.4.2. Kết quả so sánh [73](#kết-quả-so-sánh)](#kết-quả-so-sánh)

[5.4.3. Phân tích [73](#phân-tích)](#phân-tích)

[5.5. Phân tích overhead và chi phí tài nguyên [74](#phân-tích-overhead-và-chi-phí-tài-nguyên)](#phân-tích-overhead-và-chi-phí-tài-nguyên)

[5.5.1. Thời gian thực thi [74](#thời-gian-thực-thi)](#thời-gian-thực-thi)

[5.5.2. Bộ nhớ [75](#bộ-nhớ)](#bộ-nhớ)

[5.5.3. Trade-off chi phí - lợi ích [76](#trade-off-chi-phí---lợi-ích)](#trade-off-chi-phí---lợi-ích)

[5.6. Bàn luận tổng hợp [77](#bàn-luận-tổng-hợp)](#bàn-luận-tổng-hợp)

[5.6.1. Tại sao DT-Guard hiệu quả? [77](#tại-sao-dt-guard-hiệu-quả)](#tại-sao-dt-guard-hiệu-quả)

[5.6.2. Tại sao FPR = 0%? [78](#tại-sao-fpr-0)](#tại-sao-fpr-0)

[5.6.3. So sánh trực tiếp với LUP [78](#so-sánh-trực-tiếp-với-lup)](#so-sánh-trực-tiếp-với-lup)

[5.6.4. Các hạn chế nhận diện được [78](#các-hạn-chế-nhận-diện-được)](#các-hạn-chế-nhận-diện-được)

[5.7. Tổng kết chương [78](#tổng-kết-chương-3)](#tổng-kết-chương-3)

[Chương 6. KẾT LUẬN VÀ KHUYẾN NGHỊ [79](#chương-6.-kết-luận-và-khuyến-nghị)](#chương-6.-kết-luận-và-khuyến-nghị)

[6.1. Tổng kết kết quả và đóng góp khoa học [79](#tổng-kết-kết-quả-và-đóng-góp-khoa-học)](#tổng-kết-kết-quả-và-đóng-góp-khoa-học)

[6.2. Các hạn chế của hệ thống [79](#các-hạn-chế-của-hệ-thống)](#các-hạn-chế-của-hệ-thống)

[6.3. Hướng phát triển tiếp theo [80](#hướng-phát-triển-tiếp-theo)](#hướng-phát-triển-tiếp-theo)

[6.4. Kết luận luận văn [80](#kết-luận-luận-văn)](#kết-luận-luận-văn)

[TÀI LIỆU THAM KHẢO [81](#tài-liệu-tham-khảo)](#tài-liệu-tham-khảo)

[Tiếng Anh [81](#tiếng-anh)](#tiếng-anh)
...
[Bảng 2.1. So sánh DT-Guard với các phương pháp phòng thủ và framework liên quan [31](#_Toc228033024)](#_Toc228033024)

[Bảng 4.1: Bảng tổng hợp các ký hiệu toán học chính [47](#_Toc228034265)](#_Toc228034265)

[Bảng 4.2 Bảng tổng hợp tham số Trust Gate [61](#_Toc228033025)](#_Toc228033025)

[Bảng 5.1. So sánh chi tiết năm mô hình sinh dữ liệu trên CIC-IoT-2023 [78](#_Toc228034267)](#_Toc228034267)

[Bảng 5.2. Trade-off chi phí - lợi ích giữa DT-Guard và các phương pháp đại diện [88](#_Toc228034268)](#_Toc228034268)

# DANH MỤC HÌNH

[Hình 2.1. Kiến trúc IoT 3 lớp [17](#_Toc228106951)](#_Toc228106951)

[Hình 3.1. Vòng đời Digital Twin [39](#_Toc228106952)](#_Toc228106952)

[Hình 4.1. Kiến trúc tổng quát DT-Guard [50](#_Toc228106953)](#_Toc228106953)

[Hình 4.2. Kiến trúc chi tiết DT Verification Environment [51](#_Toc228107377)](#_Toc228107377)

[Hình 4.3. Pipeline kiểm định hành vi 4 lớp với Trust-Score [57](#_Toc228106955)](#_Toc228106955)

[Hình 4.4. Cơ chế DT-PW với Effort Gate [62](#_Toc228106956)](#_Toc228106956)

[Hình 5.1. Accuracy và Detection Rate trên CIC-IoT-2023 theo 4 mức tỉ lệ malicious [69](#_Toc228106957)](#_Toc228106957)

[Hình 5.2. Heatmap False Positive Rate (FPR) trên CIC-IoT-2023 theo 4 mức tỉ lệ malicious. [71](#_Toc228106958)](#_Toc228106958)

[Hình 5.3. Accuracy và Detection Rate trên ToN-IoT theo 4 mức tỉ lệ malicious. [73](#_Toc228107383)](#_Toc228107383)

[Hình 5.4. Heatmap False Positive Rate (FPR) trên ToN-IoT theo 4 mức tỉ lệ malicious. [75](#_Toc228106960)](#_Toc228106960)

[Hình 5.5. Kết quả A/B Testing mô hình sinh dữ liệu [82](#_Toc228106961)](#_Toc228106961)

[Hình 5.6. Trọng số per-client theo từng chiến lược tổng hợp [84](#_Toc228107206)](#_Toc228107206)

[Hình 5.7. Tổng hợp chi phí tính toán: (a) phân tích thời gian per-round và (b) overhead server-side, accuracy, peak memory theo từng phương pháp [86](#_Toc228106963)](#_Toc228106963)
...
**(1)** Xây dựng khung DT-Guard tích hợp Digital Twin làm môi trường kiểm chứng hành vi chủ động. Digital Twin đóng vai trò sandbox tách biệt để chủ động kiểm chứng năng lực suy luận của từng mô hình cục bộ trên dữ liệu thách thức được kiểm soát, thông qua pipeline kiểm định 4 lớp.

**(2)** Thiết kế cơ chế DT-PW (DT-Driven Performance Weighting) để định lượng đóng góp tri thức thực tế và phát hiện free-rider, kết hợp Effort Gate xác định ngưỡng thích ứng.

**(3)** Đánh giá toàn diện trên hai bộ dữ liệu IoT IDS tiêu chuẩn (CIC-IoT-2023 \[11\] và ToN-IoT), so sánh với chín phương pháp phòng thủ đại diện hiện nay.
...
![](_extract/media/media/image2.png){width="6.263888888888889in" height="4.384722222222222in"}

[]{#_Toc228106951 .anchor}Hình 2.1. Kiến trúc IoT 3 lớp
...
[]{#_Toc228033024 .anchor}Bảng 2.1. So sánh DT-Guard với các phương pháp phòng thủ và framework liên quan
...
![](_extract/media/media/image3.png){width="6.263888888888889in" height="5.586111111111111in"}

[]{#_Toc228106952 .anchor}Hình 3.1. Vòng đời Digital Twin
...
[]{#_Toc228034265 .anchor}Bảng 4.1: Bảng tổng hợp các ký hiệu toán học chính
...
![](_extract/media/media/image4.png){width="6.263888888888889in" height="7.84375in"}

[]{#_Toc228106953 .anchor}
...
![](_extract/media/media/image5.png){width="6.263888888888889in" height="4.742361111111111in"}

[]{#_Toc228107377 .anchor}Hình 4.2. Kiến trúc chi tiết DT Verification Environment
...
**Bước ④ (Update).** Mô hình toàn cục mới được tổng hợp: **w**⁽ᵗ⁾ = ∑ᵢ∈A wᵢ · **w**ᵢ⁽ᵗ⁾, với trọng số:
...
![](_extract/media/media/image6.png){width="6.263888888888889in" height="6.135416666666667in"}

[]{#_Toc228106955 .anchor}Hình 4.3. Pipeline kiểm định hành vi 4 lớp với Trust-Score
...
[]{#_Toc228033025 .anchor}**Bảng 4.2 Bảng tổng hợp tham số Trust Gate**
...
![](_extract/media/media/image7.png){width="6.263888888888889in" height="4.781944444444444in"}

[]{#_Toc228106956 .anchor}Hình 4.4. Cơ chế DT-PW với Effort Gate
...
Trong đó μ_d = mean({dᵢ}*{i∈𝒯}) là trung bình, σ_d = std({dᵢ}*{i∈𝒯}) là độ lệch chuẩn, và β \> 0 kiểm soát độ nhạy. β lớn → ngưỡng thấp → ít client bị coi là free-rider; β nhỏ → ngưỡng cao → nghiêm ngặt hơn.
...
Kịch bản A đánh giá hiệu năng phòng thủ của DT-Guard trên **hai bộ dữ liệu** (CIC-IoT-2023 và ToN-IoT) với **bốn mức tỉ lệ client độc hại** (10%, 20%, 40%, 50%), tổng cộng 5 tấn công × 4 tỉ lệ × 2 dataset = 40 kịch bản.

### 5.2.1. Kết quả trên CIC-IoT-2023

CIC-IoT-2023 có 39 đặc trưng và 34 lớp phân loại, được coi là kịch bản khó nhất trong hai dataset. Phần này phân tích kết quả qua hai hình minh chứng chính: **Hình 5.1** cho cặp Accuracy + Detection Rate và **Hình 5.2** cho heatmap FPR

![](_extract/media/media/image8.png){width="6.263888888888889in" height="7.751388888888889in"}

[]{#_Toc228106957 .anchor}Hình 5.1. Accuracy và Detection Rate trên CIC-IoT-2023 theo 4 mức tỉ lệ malicious

**Mỗi cặp panel ghép Accuracy của 10 phương pháp phòng thủ với Detection Rate tương ứng của DT-Guard trên 5 tấn công.**
...
![](_extract/media/media/image9.png){width="6.263888888888889in" height="2.4319444444444445in"}

[]{#_Toc228106958 .anchor}Hình 5.2. Heatmap False Positive Rate (FPR) trên CIC-IoT-2023 theo 4 mức tỉ lệ malicious.

**Mỗi ô là tỷ lệ client lành tính bị loại nhầm ở một cặp (defense, attack); ô càng đậm đỏ càng nhiều client bị loại oan.**
...
ToN-IoT có 10 đặc trưng và 10 lớp phân loại, không gian đặc trưng nhỏ hơn nhiều so với CIC-IoT-2023. Phần này áp dụng cùng bố cục phân tích: **Hình 5.3** cho cặp Accuracy + Detection Rate và **Hình 5.4** cho heatmap FPR

![](_extract/media/media/image10.png){width="6.263888888888889in" height="7.736111111111111in"}

[]{#_Toc228107383 .anchor}Hình 5.3. Accuracy và Detection Rate trên ToN-IoT theo 4 mức tỉ lệ malicious.
...
![](_extract/media/media/image11.png){width="6.263888888888889in" height="2.4319444444444445in"}

[]{#_Toc228106960 .anchor}Hình 5.4. Heatmap False Positive Rate (FPR) trên ToN-IoT theo 4 mức tỉ lệ malicious.

**Quan sát hàng DT-Guard hoàn toàn trắng so với hàng LUP, PoC, SignGuard có nhiều ô đỏ đậm.**
...
[]{#_Toc228034267 .anchor}Bảng 5.1. So sánh chi tiết năm mô hình sinh dữ liệu trên CIC-IoT-2023
...
![](_extract/media/media/image12.png){width="6.263888888888889in" height="6.763888888888889in"}

[]{#_Toc228106961 .anchor}Hình 5.5. Kết quả A/B Testing mô hình sinh dữ liệu
...
![](_extract/media/media/image13.png){width="6.263888888888889in" height="1.6263888888888889in"}[]{#_Toc228107206 .anchor}
...
**(1)** DT-PW là chiến lược duy nhất phát hiện và loại bỏ hoàn toàn free-rider, nhờ đo hành vi suy luận (prediction divergence) thay vì khoảng cách tham số.

**(2)** Trust-Score dựa trên khoảng cách tham số có lỗ hổng cấu trúc, vô tình thưởng cho free-rider. Đây là bằng chứng mạnh nhất cho thấy chỉ dựa vào đặc trưng tĩnh của tham số sẽ không phản ánh đúng đóng góp thực tế.

**(3)** DT-PW vừa đảm bảo công bằng vừa cải thiện chất lượng mô hình nhờ ưu tiên client đóng góp tri thức mới.
...
![](_extract/media/media/image14.png){width="3.4583333333333335in" height="4.222222222222222in"}

[]{#_Toc228106963 .anchor}Hình 5.7. Tổng hợp chi phí tính toán: (a) phân tích thời gian per-round và (b) overhead server-side, accuracy, peak memory theo từng phương pháp
...
[]{#_Toc228034268 .anchor}Bảng 5.2. Trade-off chi phí - lợi ích giữa DT-Guard và các phương pháp đại diện
...
**(1)** Tích hợp Blockchain cho audit log bất biến \[21\]. Ghi nhận Trust-Score và quyết định verification lên chain để đảm bảo tính minh bạch và kiểm toán.

**(2)** Triển khai trên testbed IoT thực tế. Đánh giá trên môi trường vật lý gồm nhiều thiết bị IoT khác nhau để kiểm chứng tính khả thi khi có độ trễ mạng và tài nguyên hạn chế.

**(3)** Quy mô lớn: parallel và hierarchical verification. Chạy nhiều DT instance song song, kết hợp sampling chỉ kiểm chứng ngẫu nhiên một tỉ lệ client mỗi round. Mở rộng sang kiến trúc phân cấp (edge → fog → cloud).

**(4)** Mở rộng sang FL bất đồng bộ. Điều chỉnh Trust Gate so sánh với snapshot mô hình toàn cục tại thời điểm nhận update, và điều chỉnh Effort Gate cho ngưỡng divergence phù hợp.
...
**Về mặt khoa học**, đóng góp quan trọng nhất là chuyển dịch phòng thủ FL từ phân tích tham số thụ động sang kiểm chứng hành vi chủ động. Ba khoảng trống nghiên cứu đã được giải quyết: phòng thủ hiệu quả trước năm loại tấn công, phân biệt chính xác Non-IID và đầu độc, phát hiện và loại bỏ free-rider.
